  ...
  <div className="row g-3 mb-4 text-center">
    <div className="col-md-4">
      <div className="border rounded p-3 bg-light shadow-sm">
        ...
        <div className="fs-5 text-capitalize">{report.topperName || "Topper Name"}</div>
        <div className="text-muted small">score - {report.topperScore || "--"}</div>
      </div>
    </div>
    <div className="col-md-4">
      <div className="border rounded p-3 bg-light shadow-sm">
        <div className="fw-bold text-secondary">2nd</div>
        <div className="fs-5 text-capitalize">{report.secondName || "Second Name"}</div>
        <div className="text-muted small">score - {report.secondScore || "--"}</div>
      </div>
    </div>
    <div className="col-md-4">
      <div className="border rounded p-3 bg-light shadow-sm">
        <div className="fw-bold text-secondary">3rd</div>
        <div className="fs-5 text-capitalize">{report.thirdName || "Third Name"}</div>
        <div className="text-muted small">score - {report.thirdScore || "--"}</div>
      </div>
    </div>
  </div>
</div>
...
<div className="container-fluid mt-5">
  ...
  <div className="text-muted small mt-3 text-center">
    ...
    <span className="me-3 text-warning">Average: <strong>{report.averageAccuracy || 0}%</strong></span>
    <span className="text-primary">You: <strong>{report.yourAccuracy || 0}%</strong></span>
  </div>
</div>
